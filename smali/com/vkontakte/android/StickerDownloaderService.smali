...
.method public static generateSizesFile(Ljava/io/File;)V
    ...
    .line 287
    :try_start_0
    new-instance v7, Lcom/vkontakte/android/StickerDownloaderService$1;

    invoke-direct {v7}, Lcom/vkontakte/android/StickerDownloaderService$1;-><init>()V

    invoke-virtual {p0, v7}, Ljava/io/File;->list(Ljava/io/FilenameFilter;)[Ljava/lang/String;
    ...
    invoke-direct {v4, p0, v7}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    .line 297
    .local v4, "sizes":Ljava/io/File;
    ...
    .end local v4    # "sizes":Ljava/io/File;
    :goto_1
    return-void
    ...
    .restart local v4    # "sizes":Ljava/io/File;
    :cond_1

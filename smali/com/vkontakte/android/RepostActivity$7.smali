...
.method public success(III)V
    ...
    invoke-virtual {v0, v1, v3}, Lcom/vkontakte/android/NewsEntry;->flag(IZ)V

    .line 167
    :cond_0
    invoke-virtual {v8, v4, v3}, Lcom/vkontakte/android/NewsEntry;->flag(IZ)V

    .line 168
    const/16 v0, 0x80

    invoke-virtual {v8, v0, v3}, Lcom/vkontakte/android/NewsEntry;->flag(IZ)V

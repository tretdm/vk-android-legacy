...
.method static synthetic access$000(Lcom/vkontakte/android/ui/WriteBar;)Lcom/vkontakte/android/ui/AttachmentsEditorView;
    .locals 1
...
.method static synthetic access$100(Lcom/vkontakte/android/ui/WriteBar;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/vkontakte/android/ui/WriteBar;
    .param p1, "x1"    # Z
...
.method static synthetic access$200(Lcom/vkontakte/android/ui/WriteBar;)Ljava/lang/Runnable;
    .locals 1
    .param p0, "x0"    # Lcom/vkontakte/android/ui/WriteBar;
...
.method static synthetic access$202(Lcom/vkontakte/android/ui/WriteBar;Ljava/lang/Runnable;)Ljava/lang/Runnable;
    .locals 0
    .param p0, "x0"    # Lcom/vkontakte/android/ui/WriteBar;
...
.method static synthetic access$300(Lcom/vkontakte/android/ui/WriteBar;)Ljava/lang/Runnable;
    .locals 1
    .param p0, "x0"    # Lcom/vkontakte/android/ui/WriteBar;
...
.method static synthetic access$302(Lcom/vkontakte/android/ui/WriteBar;Ljava/lang/Runnable;)Ljava/lang/Runnable;
    .locals 0
    .param p0, "x0"    # Lcom/vkontakte/android/ui/WriteBar;
    .param p1, "x1"    # Ljava/lang/Runnable;
...
.method static synthetic access$400(Lcom/vkontakte/android/ui/WriteBar;)Z
    .locals 1
    .param p0, "x0"    # Lcom/vkontakte/android/ui/WriteBar;
...
.method static synthetic access$500(Lcom/vkontakte/android/ui/WriteBar;)I
    .locals 1
    .param p0, "x0"    # Lcom/vkontakte/android/ui/WriteBar;
...
.method static synthetic access$600(Lcom/vkontakte/android/ui/WriteBar;)Landroid/app/Fragment;
    .locals 1
    .param p0, "x0"    # Lcom/vkontakte/android/ui/WriteBar;
...
.method static synthetic access$700(Lcom/vkontakte/android/ui/WriteBar;)V
    .locals 0
    .param p0, "x0"    # Lcom/vkontakte/android/ui/WriteBar;
...
.method private chooseVideo()V
    ...
    .line 346
    iget-object v2, p0, Lcom/vkontakte/android/ui/WriteBar;->fragment:Landroid/app/Fragment;
...
.method public addFwdMessages(Ljava/util/ArrayList;)V
    ...
    new-instance v6, Lcom/vkontakte/android/FwdMessagesAttachment;

    invoke-direct {v6, p1}, Lcom/vkontakte/android/FwdMessagesAttachment;-><init>(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v5, v3}, Lcom/vkontakte/android/ui/AttachmentsEditorView;->removeWithoutCallback(I)V
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-direct {v0, v13}, Lcom/vkontakte/android/ui/WriteBar;->setAttEditorVisible(Z)V
    ...
    iget-object v13, v0, Lcom/vkontakte/android/ui/WriteBar;->attEditor:Lcom/vkontakte/android/ui/AttachmentsEditorView;

    new-instance v14, Lcom/vkontakte/android/AudioAttachment;

    invoke-direct {v14, v4}, Lcom/vkontakte/android/AudioAttachment;-><init>(Lcom/vkontakte/android/AudioFile;)V
    ...
    .line 399
    .local v11, "video":Lcom/vkontakte/android/api/VideoFile;
    move-object/from16 v0, p0
    ...
    .line 401
    .end local v11    # "video":Lcom/vkontakte/android/api/VideoFile;
    :cond_4
    const/16 v13, 0x2711
    ...
    invoke-virtual {v13, v1}, Lcom/vkontakte/android/ui/AttachmentsEditorView;->add(Lcom/vkontakte/android/Attachment;)V
    ...
    iget-object v14, v0, Lcom/vkontakte/android/ui/WriteBar;->attEditor:Lcom/vkontakte/android/ui/AttachmentsEditorView;
    ...
    check-cast v13, Lcom/vkontakte/android/GeoAttachment;

    invoke-virtual {v14, v13}, Lcom/vkontakte/android/ui/AttachmentsEditorView;->add(Lcom/vkontakte/android/Attachment;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/vkontakte/android/ui/WriteBar;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {v7, v13, v14}, Landroid/media/MediaMetadataRetriever;->setDataSource(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 429
    .local v10, "vf":Lcom/vkontakte/android/api/VideoFile;
    invoke-virtual/range {p3 .. p3}, Landroid/content/Intent;->getData()Landroid/net/Uri;
    ...
    .line 430
    iput v3, v10, Lcom/vkontakte/android/api/VideoFile;->duration:I
    ...
    .line 432
    new-instance v9, Lcom/vkontakte/android/PendingVideoAttachment;

    invoke-direct {v9, v10}, Lcom/vkontakte/android/PendingVideoAttachment;-><init>(Lcom/vkontakte/android/api/VideoFile;)V

    .line 433
    .local v9, "pva":Lcom/vkontakte/android/PendingVideoAttachment;
    invoke-static {}, Lcom/vkontakte/android/UploaderService;->getNewID()I

    move-result v13

    iput v13, v9, Lcom/vkontakte/android/PendingVideoAttachment;->vid:I
    ...
    .end local v9    # "pva":Lcom/vkontakte/android/PendingVideoAttachment;
    .end local v10    # "vf":Lcom/vkontakte/android/api/VideoFile;
    :cond_8
    ...
    const-string v14, "Error getting video duration!"
    ...
    .restart local v10    # "vf":Lcom/vkontakte/android/api/VideoFile;
    :cond_a
    ...
    invoke-static {v14}, Lcom/vkontakte/android/UploaderService;->getRealPathFromURI(Landroid/net/Uri;)Ljava/lang/String;

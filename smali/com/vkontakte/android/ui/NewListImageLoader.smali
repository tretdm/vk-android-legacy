...
.method static synthetic access$0(Lcom/vkontakte/android/ui/NewListImageLoader;)Lcom/vkontakte/android/ui/ListImageLoaderAdapter;
    .locals 1
...
.method static synthetic access$1(Lcom/vkontakte/android/ui/NewListImageLoader;)Ljava/util/concurrent/Semaphore;
    .locals 1
...
.method static synthetic access$2(Lcom/vkontakte/android/ui/NewListImageLoader;)Ljava/util/Vector;
    .locals 1
...
.method public cancelAll()V
    ...
    .line 125
    :try_start_0
    iget-object v1, p0, Lcom/vkontakte/android/ui/NewListImageLoader;->semaphore:Ljava/util/concurrent/Semaphore;
    ...
    .line 126
    :goto_0
    iget-object v1, p0, Lcom/vkontakte/android/ui/NewListImageLoader;->incomplete:Ljava/util/Vector;
    ...
    check-cast v0, Lcom/vkontakte/android/ui/NewListImageLoader$RunnableTask;

    .line 128
    .local v0, "t":Lcom/vkontakte/android/ui/NewListImageLoader$RunnableTask;
    invoke-virtual {v0}, Lcom/vkontakte/android/ui/NewListImageLoader$RunnableTask;->cancel()V

    goto :goto_1

    .line 125
    .end local v0    # "t":Lcom/vkontakte/android/ui/NewListImageLoader$RunnableTask;
    :catch_0
    move-exception v1
...
.method public isLoading(I)Z
    ...
    .line 87
    .local v0, "t":Lcom/vkontakte/android/ui/NewListImageLoader$RunnableTask;
    iget v2, v0, Lcom/vkontakte/android/ui/NewListImageLoader$RunnableTask;->item:I
...
.method public loadRange(II)V
    ...
    .line 54
    iget-object v1, p0, Lcom/vkontakte/android/ui/NewListImageLoader;->adapter:Lcom/vkontakte/android/ui/ListImageLoaderAdapter;
...
.method public loadSingleItem(I)V
    ...
    invoke-direct {v2, p0, v3}, Lcom/vkontakte/android/ui/NewListImageLoader$RunnableTask;-><init>(Lcom/vkontakte/android/ui/NewListImageLoader;Lcom/vkontakte/android/ui/NewListImageLoader$RunnableTask;)V
...
.method public setIsScrolling(Z)V
    ...
    :goto_2
    invoke-virtual {v0, v1}, Lcom/vkontakte/android/ui/NewListImageLoader$RunnableTask;->setDecode(Z)V

...
.method static synthetic access$0(Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;I)V
    .locals 0
...
.method static synthetic access$1(Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;)Ljava/util/concurrent/ArrayBlockingQueue;
    .locals 1
...
.method static synthetic access$10(Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;)Ljava/util/concurrent/ArrayBlockingQueue;
    .locals 1
...
.method static synthetic access$11(Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;Z)V
    .locals 0
...
.method static synthetic access$2(Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;)I
    .locals 1
...
.method static synthetic access$3(Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;)V
    .locals 0
...
.method static synthetic access$4(Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;)Z
    .locals 1
...
.method static synthetic access$5(Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;)I
    .locals 1
...
.method static synthetic access$6(Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;)I
    .locals 1
...
.method static synthetic access$7(Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;)I
    .locals 1
...
.method static synthetic access$8(Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;I)Landroid/graphics/Bitmap;
    .locals 1
...
.method static synthetic access$9(Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;)Z
    .locals 1
...
.method public getImageByUri(Landroid/app/Activity;Landroid/net/Uri;)Lcom/vkontakte/android/mediapicker/entries/ImageEntry;
    ...
    const-string v1, "Getting image by uri %s, scheme: %s file: %s"
    ...
    invoke-static {v1, v2}, Lcom/vkontakte/android/mediapicker/utils/Loggable;->Warn(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v1}, Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;->tryFixContentPath(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    invoke-static {v8}, Lcom/vkontakte/android/mediapicker/utils/GalleryPickerUtils;->closeCursor(Landroid/database/Cursor;)V
    ...
    invoke-static {v1}, Lcom/vkontakte/android/mediapicker/utils/GalleryPickerUtils;->getFilePath(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "Getting content image by path result. Path: %s, count: %d"
    ...
    new-instance v13, Lcom/vkontakte/android/mediapicker/entries/ImageEntry;

    const/4 v1, 0x1

    move-object/from16 v0, v17

    invoke-direct {v13, v11, v0, v1, v15}, Lcom/vkontakte/android/mediapicker/entries/ImageEntry;-><init>(ILjava/lang/String;ZI)V

    .line 640
    .local v13, "image":Lcom/vkontakte/android/mediapicker/entries/ImageEntry;
    :goto_1
    if-eqz v7, :cond_6

    .line 641
    invoke-virtual {v13, v7}, Lcom/vkontakte/android/mediapicker/entries/ImageEntry;->setBucketId(I)V
    ...
    invoke-virtual {v0, v13, v1}, Lcom/vkontakte/android/mediapicker/utils/LocalImageLoader;->setOrientationByPath(Lcom/vkontakte/android/mediapicker/entries/ImageEntry;Ljava/io/File;)V

    .line 646
    .end local v8    # "cursor":Landroid/database/Cursor;
    .end local v11    # "id":I
    .end local v13    # "image":Lcom/vkontakte/android/mediapicker/entries/ImageEntry;
    :cond_7
    :goto_2
    return-object v13
    ...
    .line 590
    .local v10, "fix":Ljava/lang/String;
    if-eqz v10, :cond_b
    ...
    .line 595
    .local v18, "splitted":[Ljava/lang/String;
    const-string v10, ""
    ...
    .end local v10    # "fix":Ljava/lang/String;
    .end local v12    # "idIndex":I
    .end local v14    # "orIndex":I
    .end local v16    # "part":Ljava/lang/String;
    .end local v18    # "splitted":[Ljava/lang/String;
    :cond_e
    const/4 v13, 0x0
    ...
    invoke-direct {v13, v11, v0, v15}, Lcom/vkontakte/android/mediapicker/entries/ImageEntry;-><init>(ILjava/lang/String;I)V

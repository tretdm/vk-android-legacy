...
.method public static retrieveSelectedImages()Ljava/util/List;
    ...
    .line 95
    .local v1, "images":Ljava/util/HashSet;, "Ljava/util/HashSet<Lcom/vkontakte/android/mediapicker/entries/ImageEntry;>;"
    .local v2, "result":Ljava/util/List;, "Ljava/util/List<Lcom/vkontakte/android/mediapicker/entries/ImageEntry;>;"
    :goto_0
    return-object v2

    .line 84
    .end local v1    # "images":Ljava/util/HashSet;, "Ljava/util/HashSet<Lcom/vkontakte/android/mediapicker/entries/ImageEntry;>;"
    .end local v2    # "result":Ljava/util/List;, "Ljava/util/List<Lcom/vkontakte/android/mediapicker/entries/ImageEntry;>;"
    :cond_0
    sget-object v1, Lcom/vkontakte/android/mediapicker/utils/SelectionContext;->selectedImages:Ljava/util/HashSet;

    .line 85
    .restart local v1    # "images":Ljava/util/HashSet;, "Ljava/util/HashSet<Lcom/vkontakte/android/mediapicker/entries/ImageEntry;>;"
    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    .line 87
    .restart local v2    # "result":Ljava/util/List;, "Ljava/util/List<Lcom/vkontakte/android/mediapicker/entries/ImageEntry;>;"

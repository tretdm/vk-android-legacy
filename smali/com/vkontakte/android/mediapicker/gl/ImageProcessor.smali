...
.method static synthetic access$000(Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;Ljava/lang/String;[Ljava/lang/Object;)V
    .locals 0
    .param p0, "x0"    # Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;
...
.method static synthetic access$100(Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;Ljava/lang/String;ILcom/vkontakte/android/mediapicker/entries/BitmapEntry;Lcom/vkontakte/android/mediapicker/entries/ActionCallback;)V
    .locals 0
    .param p0, "x0"    # Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;
    .param p1, "x1"    # Ljava/lang/String;
    .param p2, "x2"    # I
    .param p3, "x3"    # Lcom/vkontakte/android/mediapicker/entries/BitmapEntry;
    .param p4, "x4"    # Lcom/vkontakte/android/mediapicker/entries/ActionCallback;
...
.method static synthetic access$200(Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;)Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 1
    .param p0, "x0"    # Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;
...
.method static synthetic access$300(Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;
    .param p1, "x1"    # Z
...
.method static synthetic access$400(Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;Z)V
    .locals 0
    .param p0, "x0"    # Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;
    .param p1, "x1"    # Z
...
.method static synthetic access$500(Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;)V
    .locals 0
    .param p0, "x0"    # Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;
...
.method static synthetic access$600(Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;Landroid/graphics/Bitmap;[F)Landroid/graphics/Bitmap;
    .locals 1
    .param p0, "x0"    # Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;
...
.method static synthetic access$700(Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    .locals 1
    .param p0, "x0"    # Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;
    .param p1, "x1"    # Landroid/graphics/Bitmap;
...
.method static synthetic access$800(Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;Landroid/graphics/Bitmap;ILjava/lang/String;)Landroid/graphics/Bitmap;
    .locals 1
    .param p0, "x0"    # Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;
    .param p1, "x1"    # Landroid/graphics/Bitmap;
    .param p2, "x2"    # I
...
.method private clearFilters(Z)V
    ...
    .line 476
    .end local v0    # "context":Lcom/vkontakte/android/mediapicker/gl/GLFilterContext;
    .end local v1    # "fid":Ljava/lang/Integer;
    ...
    const-string v5, "Cannot clear filters contexts"

    const/4 v6, 0x0

    new-array v6, v6, [Ljava/lang/Object;

    invoke-static {v5, v4, v6}, Lcom/vkontakte/android/mediapicker/utils/Loggable;->GLError(Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    ...
    .restart local v3    # "keys":Ljava/util/Set;, "Ljava/util/Set<Ljava/lang/Integer;>;"
    :cond_2
    :try_start_1
    iget-object v5, p0, Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;->filterContexts:Ljava/util/HashMap;
...
.method private clearTextures(Z)V
    ...
    iput-object v5, p0, Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;->last_image_key:Ljava/lang/String;
    ...
    check-cast v3, Lcom/vkontakte/android/mediapicker/gl/GLTexture;

    .line 434
    .local v3, "texture":Lcom/vkontakte/android/mediapicker/gl/GLTexture;
    if-eqz v3, :cond_1
    ...
    .line 440
    invoke-virtual {v3}, Lcom/vkontakte/android/mediapicker/gl/GLTexture;->unload()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v3    # "texture":Lcom/vkontakte/android/mediapicker/gl/GLTexture;
    :catch_0
    move-exception v4

    .line 448
    .local v4, "throwable":Ljava/lang/Throwable;
    const-string v5, "Cannot clear source textures"

...
.field final synthetic val$bitmapCallback:Lcom/vkontakte/android/mediapicker/entries/ActionCallback;

.field final synthetic val$bitmapEntry:Lcom/vkontakte/android/mediapicker/entries/BitmapEntry;

.field final synthetic val$context:I

.field final synthetic val$image:Lcom/vkontakte/android/mediapicker/entries/ImageEntry;

.field final synthetic val$image_key:Ljava/lang/String;
...
.method public run()V
    ...
    .line 299
    iget-object v1, p0, Lcom/vkontakte/android/mediapicker/gl/ImageProcessor$5;->val$bitmapCallback:Lcom/vkontakte/android/mediapicker/entries/ActionCallback;

    iget-object v2, p0, Lcom/vkontakte/android/mediapicker/gl/ImageProcessor$5;->val$bitmapEntry:Lcom/vkontakte/android/mediapicker/entries/BitmapEntry;

    invoke-virtual {v2}, Lcom/vkontakte/android/mediapicker/entries/BitmapEntry;->get()Ljava/lang/Object;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/vkontakte/android/mediapicker/entries/ActionCallback;->exec(Ljava/lang/Object;)V
    ...
    invoke-static {v1, v2, v3, v4, v5}, Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;->access$100(Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;Ljava/lang/String;ILcom/vkontakte/android/mediapicker/entries/BitmapEntry;Lcom/vkontakte/android/mediapicker/entries/ActionCallback;)V
    :try_end_0
    ...
    invoke-static {v1}, Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;->access$200(Lcom/vkontakte/android/mediapicker/gl/ImageProcessor;)Ljava/util/concurrent/atomic/AtomicInteger;

...
.method static synthetic access$3(II)V
    .locals 0
...
.method public static endPlayback(IIII)V
    ...
    const-string v22, "End playback for "
    ...
    .line 295
    sget-boolean v20, Lcom/vkontakte/android/cache/AudioCache;->deleteCurrent:Z
    ...
    sput-boolean v20, Lcom/vkontakte/android/cache/AudioCache;->deleteCurrent:Z
    ...
    const-string v22, "Renaming file "
    ...
    const-string v22, ".vkontakte/cache/audio/"
    ...
    .line 313
    sget-object v20, Lcom/vkontakte/android/cache/AudioCache;->cachedIDs:Ljava/util/Vector;
    ...
    .line 315
    :cond_4
    sget-object v20, Lcom/vkontakte/android/cache/AudioCache;->cacheReqs:Ljava/util/Vector;
    ...
    const-string v20, "com.vkontakte.android.UPDATE_AUDIO_LISTS"
    ...
    .line 318
    .local v13, "intent":Landroid/content/Intent;
    const-string v20, "reload_cached_list"
    ...
    .line 322
    :cond_7
    sget-object v20, Lcom/vkontakte/android/cache/AudioCache;->ranges:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    check-cast v18, Lcom/vkontakte/android/cache/AudioCache$RangesInfo;

    .line 324
    .local v18, "rn":Lcom/vkontakte/android/cache/AudioCache$RangesInfo;
    if-nez v18, :cond_8
    ...
    new-instance v20, Lcom/vkontakte/android/cache/AudioCache$2;

    invoke-direct/range {v20 .. v20}, Lcom/vkontakte/android/cache/AudioCache$2;-><init>()V
    ...
    iget v15, v0, Lcom/vkontakte/android/cache/AudioCache$RangesInfo;->l:I
    ...
    .line 336
    .local v17, "r":Lcom/vkontakte/android/cache/AudioCache$FileRange;
    ...
    .line 338
    invoke-static {v5, v15}, Lcom/vkontakte/android/cache/AudioCache;->dbgRanges(Ljava/util/ArrayList;I)V

    goto :goto_1

    .line 345
    .end local v5    # "al":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/cache/AudioCache$FileRange;>;"
    .end local v17    # "r":Lcom/vkontakte/android/cache/AudioCache$FileRange;
    :cond_a
    const/4 v11, 0x0
    ...
    check-cast v16, Lcom/vkontakte/android/cache/AudioCache$FileRange;

    .line 358
    .local v16, "prev":Lcom/vkontakte/android/cache/AudioCache$FileRange;
    const/4 v11, 0x1
    ...
    const-string v21, "After remove overlapping"
    ...
    check-cast v20, Lcom/vkontakte/android/cache/AudioCache$FileRange;
    ...
    const-string v21, "We already have full file"
    ...
    .line 346
    .end local v16    # "prev":Lcom/vkontakte/android/cache/AudioCache$FileRange;
    :cond_d
    const/4 v14, 0x0
    ...
    .end local v14    # "j":I
    .restart local v16    # "prev":Lcom/vkontakte/android/cache/AudioCache$FileRange;
    :cond_11
    invoke-virtual {v10, v11}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;
    ...
    .line 360
    .restart local v17    # "r":Lcom/vkontakte/android/cache/AudioCache$FileRange;
    if-nez v17, :cond_12
    ...
    invoke-direct {v7, v0}, Lcom/vkontakte/android/cache/AudioCache$FileRange;-><init>(Lcom/vkontakte/android/cache/AudioCache$FileRange;)V
    ...
    .line 392
    iput v15, v7, Lcom/vkontakte/android/cache/AudioCache$FileRange;->endOffset:I
    ...
    const-string v21, "need to download: "

    invoke-static/range {v20 .. v21}, Lcom/vkontakte/android/Log;->i(Ljava/lang/String;Ljava/lang/String;)V

    .line 396
    invoke-static {v8, v15}, Lcom/vkontakte/android/cache/AudioCache;->dbgRanges(Ljava/util/ArrayList;I)V
    ...
    iput v15, v12, Lcom/vkontakte/android/cache/AudioCache$RangesInfo;->l:I
    ...
    .line 400
    iput-object v8, v12, Lcom/vkontakte/android/cache/AudioCache$RangesInfo;->a:Ljava/util/ArrayList;
    ...
    .line 402
    invoke-static {v12}, Lcom/vkontakte/android/cache/AudioCache;->downloadParts(Lcom/vkontakte/android/cache/AudioCache$RangesInfo;)V
    ...
    .end local v15    # "l":I
    .end local v16    # "prev":Lcom/vkontakte/android/cache/AudioCache$FileRange;
    .end local v18    # "rn":Lcom/vkontakte/android/cache/AudioCache$RangesInfo;
    :cond_19

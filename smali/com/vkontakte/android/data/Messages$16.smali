.class Lcom/vkontakte/android/data/Messages$16;
...
.method constructor <init>(ILcom/vkontakte/android/data/Messages$GetChatUsersCallback;)V
    ...
    .prologue
    .line 1
    iput p1, p0, Lcom/vkontakte/android/data/Messages$16;->val$chatID:I

    iput-object p2, p0, Lcom/vkontakte/android/data/Messages$16;->val$getChatUsersCallback:Lcom/vkontakte/android/data/Messages$GetChatUsersCallback;
...
.method public run()V
    ...
    .prologue
    .line 978
    iget v2, p0, Lcom/vkontakte/android/data/Messages$16;->val$chatID:I
    ...
    const-string v3, "cache returned empty list, fallback to api"
    ...
    iget-object v3, p0, Lcom/vkontakte/android/data/Messages$16;->val$getChatUsersCallback:Lcom/vkontakte/android/data/Messages$GetChatUsersCallback;

    invoke-static {v2, v3}, Lcom/vkontakte/android/data/Messages;->access$8(ILcom/vkontakte/android/data/Messages$GetChatUsersCallback;)V
    ...
    iget-object v2, p0, Lcom/vkontakte/android/data/Messages$16;->val$getChatUsersCallback:Lcom/vkontakte/android/data/Messages$GetChatUsersCallback;

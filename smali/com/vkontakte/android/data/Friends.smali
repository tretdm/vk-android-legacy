...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/data/Friends$GetOnlinesCallback;,
...
.method static synthetic access$400()Lcom/vkontakte/android/SearchIndexer;
    .locals 1
...
.method static synthetic access$700()Landroid/util/LruCache;
    .locals 1
...
.method public static getFromAll(I)Lcom/vkontakte/android/UserProfile;
    ...
    .line 197
    :try_start_0
    sget-object v5, Lcom/vkontakte/android/data/Friends;->semaphore:Ljava/util/concurrent/Semaphore;
    ...
    .line 198
    :goto_0
    sget-object v5, Lcom/vkontakte/android/data/Friends;->friends:Ljava/util/ArrayList;
    ...
    .line 205
    sget-object v5, Lcom/vkontakte/android/data/Friends;->users:Landroid/util/LruCache;
    ...
    invoke-static {v5, v7}, Lcom/vkontakte/android/cache/Cache;->getUsers(Ljava/util/List;Z)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v8}, Lcom/vkontakte/android/cache/Cache;->getUsers(Ljava/util/List;Z)Ljava/util/ArrayList;

    move-result-object v3

    .line 214
    .local v3, "pp":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/UserProfile;>;"
    ...
    .end local v2    # "p":Lcom/vkontakte/android/UserProfile;
    .end local v3    # "pp":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/UserProfile;>;"
    :catch_0
    move-exception v5
...
.method public static getNonFriendOnlines(Ljava/util/List;Lcom/vkontakte/android/data/Friends$GetOnlinesCallback;)V
    .locals 0
    .param p1, "callback"    # Lcom/vkontakte/android/data/Friends$GetOnlinesCallback;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List",
...
.method public static getUsers(Ljava/util/List;Lcom/vkontakte/android/data/Friends$GetUsersCallback;I)V
    ...
    :cond_1
    sget-object v6, Lcom/vkontakte/android/data/Friends;->users:Landroid/util/LruCache;
    ...
    :cond_2
    invoke-static {v5}, Lcom/vkontakte/android/data/Friends;->getGroup(I)Lcom/vkontakte/android/UserProfile;
    ...
    .line 313
    sget-object v6, Lcom/vkontakte/android/data/Friends;->friends:Ljava/util/ArrayList;
    ...
    .line 325
    invoke-interface {p1, v4}, Lcom/vkontakte/android/data/Friends$GetUsersCallback;->onUsersLoaded(Ljava/util/ArrayList;)V
    ...
    new-instance v7, Lcom/vkontakte/android/data/Friends$2;

    invoke-direct {v7, v2, p2, v4, p1}, Lcom/vkontakte/android/data/Friends$2;-><init>(Ljava/util/ArrayList;ILjava/util/ArrayList;Lcom/vkontakte/android/data/Friends$GetUsersCallback;)V
...
.method public static intersect(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    :try_start_0
    sget-object v3, Lcom/vkontakte/android/data/Friends;->semaphore:Ljava/util/concurrent/Semaphore;
...
.method public static setOnlineStatus(II)V
    ...
    .line 262
    iput p1, v1, Lcom/vkontakte/android/UserProfile;->online:I

...
.method static runRequest(Lcom/vkontakte/android/APIRequest;)Lorg/json/JSONObject;
    ...
    .line 84
    :try_start_0
    sget-object v30, Lcom/vkontakte/android/APIController;->validation:Ljava/util/concurrent/Semaphore;

    invoke-virtual/range {v30 .. v30}, Ljava/util/concurrent/Semaphore;->acquire()V
    ...
    .line 87
    :goto_0
    sget v30, Lcom/vkontakte/android/APIController;->requestCounter:I
    ...
    sget-wide v32, Lcom/vkontakte/android/APIController;->counterResetTime:J
    ...
    sput v30, Lcom/vkontakte/android/APIController;->requestCounter:I
    ...
    sput-wide v30, Lcom/vkontakte/android/APIController;->counterResetTime:J
    ...
    .line 96
    .local v27, "time":J
    sget-object v30, Lcom/vkontakte/android/APIController;->httpclient:Lorg/apache/http/client/HttpClient;
    ...
    .line 99
    sget-object v30, Lcom/vkontakte/android/APIController;->USER_AGENT:Ljava/lang/String;
    ...
    .line 104
    new-instance v23, Lorg/apache/http/conn/scheme/SchemeRegistry;

    invoke-direct/range {v23 .. v23}, Lorg/apache/http/conn/scheme/SchemeRegistry;-><init>()V

    .line 105
    .local v23, "registry":Lorg/apache/http/conn/scheme/SchemeRegistry;
    new-instance v30, Lorg/apache/http/conn/scheme/Scheme;
    ...
    invoke-direct/range {v30 .. v33}, Lorg/apache/http/conn/scheme/Scheme;-><init>(Ljava/lang/String;Lorg/apache/http/conn/scheme/SocketFactory;I)V
    ...
    .line 107
    new-instance v30, Lorg/apache/http/impl/client/DefaultHttpClient;

    new-instance v31, Lorg/apache/http/impl/conn/tsccm/ThreadSafeClientConnManager;
    ...
    sput-object v30, Lcom/vkontakte/android/APIController;->httpclient:Lorg/apache/http/client/HttpClient;

    .line 124
    .end local v11    # "hParams":Lorg/apache/http/params/HttpParams;
    .end local v23    # "registry":Lorg/apache/http/conn/scheme/SchemeRegistry;
    :cond_2
    ...
    sget-object v31, Lcom/vkontakte/android/APIController;->API_URL:Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/vkontakte/android/APIRequest;->params:Ljava/util/HashMap;
    ...
    const-string v31, "access_token"

    sget-object v32, Lcom/vkontakte/android/Global;->accessToken:Ljava/lang/String;
    ...
    .line 138
    .local v20, "nameValuePairs":Ljava/util/List;, "Ljava/util/List<Lorg/apache/http/NameValuePair;>;"
    move-object/from16 v0, p0
    ...
    sget-boolean v30, Lcom/vkontakte/android/APIController;->API_DEBUG:Z
    ...
    .line 143
    :cond_7
    new-instance v31, Lorg/apache/http/message/BasicNameValuePair;
    ...
    .catch Lcom/vkontakte/android/APIException; {:try_start_2 .. :try_end_2} :catch_3
    ...
    .end local v20    # "nameValuePairs":Ljava/util/List;, "Ljava/util/List<Lorg/apache/http/NameValuePair;>;"
    :catch_1
    move-exception v6
    ...
    .restart local v20    # "nameValuePairs":Ljava/util/List;, "Ljava/util/List<Lorg/apache/http/NameValuePair;>;"
    ...
    invoke-static/range {v30 .. v31}, Lcom/vkontakte/android/Log;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v30, Lcom/vkontakte/android/Global;->secret:Ljava/lang/String;
    ...
    :cond_e
    new-instance v30, Lorg/apache/http/client/entity/UrlEncodedFormEntity;
    ...
    .catch Lcom/vkontakte/android/APIException; {:try_start_6 .. :try_end_6} :catch_3
    ...
    invoke-interface/range {v30 .. v30}, Lorg/apache/http/HttpEntity;->getContent()Ljava/io/InputStream;
    ...
    .catch Lcom/vkontakte/android/APIException; {:try_start_9 .. :try_end_9} :catch_3
    ...
    invoke-static/range {v30 .. v31}, Lcom/vkontakte/android/Log;->v(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 191
    new-instance v30, Lorg/json/JSONTokener;
    ...
    invoke-virtual/range {v30 .. v30}, Lorg/json/JSONTokener;->nextValue()Ljava/lang/Object;
    ...
    const-string v30, "execute_errors"
    ...
    .line 208
    const-string v30, "account.unregisterDevice"
    ...
    .line 209
    new-instance v30, Lcom/vkontakte/android/APIException;

    const/16 v31, 0x0

    const-string v32, "already unregistered"

    invoke-direct/range {v30 .. v32}, Lcom/vkontakte/android/APIException;-><init>(ILjava/lang/String;)V

    throw v30
    :try_end_c
    .catch Ljava/io/IOException; {:try_start_c .. :try_end_c} :catch_1
    .catch Lcom/vkontakte/android/APIException; {:try_start_c .. :try_end_c} :catch_3
    ...
    .catch Lcom/vkontakte/android/APIException; {:try_start_10 .. :try_end_10} :catch_3
    ...
    .catch Lcom/vkontakte/android/APIException; {:try_start_15 .. :try_end_15} :catch_3
    ...
    .catch Lcom/vkontakte/android/APIException; {:try_start_16 .. :try_end_16} :catch_3
    ...
    const-class v31, Lcom/vkontakte/android/CaptchaActivity;
    ...
    .line 227
    :goto_11
    sget-boolean v30, Lcom/vkontakte/android/CaptchaActivity;->isReady:Z
    ...
    const-string v32, "Captcha activity returned with "

    invoke-virtual/range {v31 .. v32}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v31

    sget-boolean v32, Lcom/vkontakte/android/CaptchaActivity;->isReady:Z
    ...
    sget-object v32, Lcom/vkontakte/android/CaptchaActivity;->lastKey:Ljava/lang/String;
    ...
    sput-boolean v30, Lcom/vkontakte/android/CaptchaActivity;->isReady:Z
    ...
    const-string v32, "Resending request "
    ...
    .catch Lcom/vkontakte/android/APIException; {:try_start_17 .. :try_end_17} :catch_3
    ...
    const-string v31, "Skipping captcha because app is in background"

    invoke-static/range {v30 .. v31}, Lcom/vkontakte/android/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface/range {v30 .. v32}, Landroid/content/SharedPreferences$Editor;->putBoolean(Ljava/lang/String;Z)Landroid/content/SharedPreferences$Editor;
    ...
    .catch Lcom/vkontakte/android/APIException; {:try_start_1a .. :try_end_1a} :catch_3
    ...
    const-string v31, "Need validation"
    ...
    .catch Lcom/vkontakte/android/APIException; {:try_start_1d .. :try_end_1d} :catch_3
    ...
    .catch Lcom/vkontakte/android/APIException; {:try_start_1e .. :try_end_1e} :catch_3
    ...
    const-class v31, Lcom/vkontakte/android/ValidationActivity;
    ...
    sput v30, Lcom/vkontakte/android/ValidationActivity;->result:I
    ...
    .line 262
    :goto_16
    sget v30, Lcom/vkontakte/android/ValidationActivity;->result:I
    ...
    const-string v32, "Repeating request "
    ...
    .catch Lcom/vkontakte/android/APIException; {:try_start_1f .. :try_end_1f} :catch_3
    ...
    const-string v31, "Skipping validation because app is in background"
    ...
    .catch Lcom/vkontakte/android/APIException; {:try_start_22 .. :try_end_22} :catch_3

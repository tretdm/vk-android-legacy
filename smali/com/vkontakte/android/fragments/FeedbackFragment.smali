...
.method private showFilter()V
    ...
    .line 154
    new-instance v8, Lcom/vkontakte/android/fragments/FeedbackFragment$3;

    invoke-direct {v8, p0, v6}, Lcom/vkontakte/android/fragments/FeedbackFragment$3;-><init>(Lcom/vkontakte/android/fragments/FeedbackFragment;[Z)V
    ...
    new-instance v9, Lcom/vkontakte/android/fragments/FeedbackFragment$4;

    invoke-direct {v9, p0, v6, v3}, Lcom/vkontakte/android/fragments/FeedbackFragment$4;-><init>(Lcom/vkontakte/android/fragments/FeedbackFragment;[Z[Ljava/lang/String;)V
...
.method public onAttach(Landroid/app/Activity;)V
    ...
    iput-object v1, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->contentView:Landroid/widget/LinearLayout;

    .line 57
    new-instance v1, Lcom/vkontakte/android/NewsView;

    invoke-direct {v1, p1}, Lcom/vkontakte/android/NewsView;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->commentsView:Lcom/vkontakte/android/NewsView;

    .line 58
    iget-object v1, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->commentsView:Lcom/vkontakte/android/NewsView;

    invoke-virtual {v1, v5}, Lcom/vkontakte/android/NewsView;->setCommentsMode(Z)V

    .line 60
    new-instance v1, Lcom/vkontakte/android/NotificationsView;

    invoke-direct {v1, p1}, Lcom/vkontakte/android/NotificationsView;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->notifyView:Lcom/vkontakte/android/NotificationsView;

    .line 61
    sget-object v1, Lcom/vkontakte/android/NotificationsView;->notifications:Ljava/util/Vector;
    ...
    .line 62
    :cond_0
    iget-object v1, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->notifyView:Lcom/vkontakte/android/NotificationsView;

    invoke-virtual {v1, v2}, Lcom/vkontakte/android/NotificationsView;->loadData(Z)V
    ...
    .line 66
    new-instance v1, Lcom/vkontakte/android/api/NotificationsMarkAsViewed;

    invoke-direct {v1}, Lcom/vkontakte/android/api/NotificationsMarkAsViewed;-><init>()V

    .line 67
    new-instance v2, Lcom/vkontakte/android/fragments/FeedbackFragment$1;

    invoke-direct {v2, p0}, Lcom/vkontakte/android/fragments/FeedbackFragment$1;-><init>(Lcom/vkontakte/android/fragments/FeedbackFragment;)V

    invoke-virtual {v1, v2}, Lcom/vkontakte/android/api/NotificationsMarkAsViewed;->setCallback(Lcom/vkontakte/android/api/NotificationsMarkAsViewed$Callback;)Lcom/vkontakte/android/APIRequest;
    ...
    iput-object v1, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->pager:Landroid/support/v4/view/ViewPager;

    .line 86
    iget-object v1, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->pager:Landroid/support/v4/view/ViewPager;

    new-instance v2, Lcom/vkontakte/android/fragments/FeedbackFragment$FeedbackPagerAdapter;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lcom/vkontakte/android/fragments/FeedbackFragment$FeedbackPagerAdapter;-><init>(Lcom/vkontakte/android/fragments/FeedbackFragment;Lcom/vkontakte/android/fragments/FeedbackFragment$FeedbackPagerAdapter;)V
    ...
    invoke-direct {v1, p1}, Lcom/astuetz/viewpager/extensions/PagerSlidingTabStrip;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->tabs:Lcom/astuetz/viewpager/extensions/PagerSlidingTabStrip;

    .line 89
    iget-object v1, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->tabs:Lcom/astuetz/viewpager/extensions/PagerSlidingTabStrip;

    iget-object v2, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->pager:Landroid/support/v4/view/ViewPager;

    invoke-virtual {v1, v2}, Lcom/astuetz/viewpager/extensions/PagerSlidingTabStrip;->setViewPager(Landroid/support/v4/view/ViewPager;)V

    .line 90
    iget-object v1, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->tabs:Lcom/astuetz/viewpager/extensions/PagerSlidingTabStrip;

    new-instance v2, Lcom/vkontakte/android/fragments/FeedbackFragment$2;

    invoke-direct {v2, p0}, Lcom/vkontakte/android/fragments/FeedbackFragment$2;-><init>(Lcom/vkontakte/android/fragments/FeedbackFragment;)V

    invoke-virtual {v1, v2}, Lcom/astuetz/viewpager/extensions/PagerSlidingTabStrip;->setOnPageChangeListener(Landroid/support/v4/view/ViewPager$OnPageChangeListener;)V
    ...
    invoke-virtual {v1, v2}, Lcom/astuetz/viewpager/extensions/PagerSlidingTabStrip;->setBackgroundResource(I)V
    ...
    invoke-virtual {v1, v2}, Lcom/astuetz/viewpager/extensions/PagerSlidingTabStrip;->setIndicatorColorResource(I)V

    .line 118
    iget-object v1, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->contentView:Landroid/widget/LinearLayout;
    ...
    iget-object v2, p0, Lcom/vkontakte/android/fragments/FeedbackFragment;->tabs:Lcom/astuetz/viewpager/extensions/PagerSlidingTabStrip;
    ...
    .line 121
    invoke-virtual {p0, v5}, Lcom/vkontakte/android/fragments/FeedbackFragment;->setHasOptionsMenu(Z)V
    ...
    invoke-virtual {v1}, Lcom/vkontakte/android/NotificationsView;->refresh()V

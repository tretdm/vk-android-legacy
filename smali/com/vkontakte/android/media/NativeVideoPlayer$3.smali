...
.method public run()V
    ...
    invoke-static {v9}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$4(Lcom/vkontakte/android/media/NativeVideoPlayer;)I
    ...
    invoke-static {v9}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$5(Lcom/vkontakte/android/media/NativeVideoPlayer;)I
    ...
    invoke-static {v10}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$5(Lcom/vkontakte/android/media/NativeVideoPlayer;)I
    ...
    invoke-static {v10}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$4(Lcom/vkontakte/android/media/NativeVideoPlayer;)I
    ...
    invoke-static {v11}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$5(Lcom/vkontakte/android/media/NativeVideoPlayer;)I
    ...
    invoke-static {v9, v8}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$6(Lcom/vkontakte/android/media/NativeVideoPlayer;Landroid/graphics/Bitmap;)V

    .line 126
    iget-object v8, p0, Lcom/vkontakte/android/media/NativeVideoPlayer$3;->this$0:Lcom/vkontakte/android/media/NativeVideoPlayer;

    invoke-static {v8}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$7(Lcom/vkontakte/android/media/NativeVideoPlayer;)Landroid/content/Context;
    ...
    invoke-static {v8}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$8(Lcom/vkontakte/android/media/NativeVideoPlayer;)Z
    :try_end_0
    ...
    invoke-static {v8}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$9(Lcom/vkontakte/android/media/NativeVideoPlayer;)Ljava/lang/Object;
    ...
    invoke-static {v8}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$10(Lcom/vkontakte/android/media/NativeVideoPlayer;)Landroid/view/SurfaceHolder;
    ...
    invoke-static {v8, v4, v1}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$11(Lcom/vkontakte/android/media/NativeVideoPlayer;Ljava/nio/IntBuffer;I)V
    ...
    invoke-static {v8}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$3(Lcom/vkontakte/android/media/NativeVideoPlayer;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v8}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$0(Lcom/vkontakte/android/media/NativeVideoPlayer;)I

    move-result v9

    add-int/lit8 v9, v9, 0x1

    invoke-static {v8, v9}, Lcom/vkontakte/android/media/NativeVideoPlayer;->access$2(Lcom/vkontakte/android/media/NativeVideoPlayer;I)V
    :try_end_3

...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/api/PollsGetById$ExCallback;,
...
.method public cancel()V
    ...
    .prologue
    .line 50
    invoke-super {p0}, Lcom/vkontakte/android/APIRequest;->cancel()V

    .line 51
    iget-object v0, p0, Lcom/vkontakte/android/api/PollsGetById;->callback:Lcom/vkontakte/android/api/PollsGetById$Callback;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/vkontakte/android/api/PollsGetById;->callback:Lcom/vkontakte/android/api/PollsGetById$Callback;

    instance-of v0, v0, Lcom/vkontakte/android/api/PollsGetById$ExCallback;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/vkontakte/android/api/PollsGetById;->callback:Lcom/vkontakte/android/api/PollsGetById$Callback;

    check-cast v0, Lcom/vkontakte/android/api/PollsGetById$ExCallback;

    invoke-interface {v0}, Lcom/vkontakte/android/api/PollsGetById$ExCallback;->canceled()V

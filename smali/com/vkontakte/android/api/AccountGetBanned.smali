.class public Lcom/vkontakte/android/api/AccountGetBanned;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/api/AccountGetBanned$Callback;
    }
.end annotation


# instance fields
.field callback:Lcom/vkontakte/android/api/AccountGetBanned$Callback;
...
.method public constructor <init>(II)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/vkontakte/android/api/AccountGetBanned;->param(Ljava/lang/String;I)Lcom/vkontakte/android/APIRequest;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/vkontakte/android/api/AccountGetBanned;->param(Ljava/lang/String;Ljava/lang/String;)Lcom/vkontakte/android/APIRequest;
...
.method public invokeCallback(Ljava/lang/Object;)V
    ...
    .prologue
    .line 52
    iget-object v2, p0, Lcom/vkontakte/android/api/AccountGetBanned;->callback:Lcom/vkontakte/android/api/AccountGetBanned$Callback;
    ...
    invoke-interface {v2, v3, v4}, Lcom/vkontakte/android/api/AccountGetBanned$Callback;->fail(ILjava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/vkontakte/android/api/AccountGetBanned;->callback:Lcom/vkontakte/android/api/AccountGetBanned$Callback;
    ...
    invoke-interface {v3, v4, v2}, Lcom/vkontakte/android/api/AccountGetBanned$Callback;->success(ILjava/util/ArrayList;)V
...
.method public parse(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    .line 25
    .local v4, "r":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/UserProfile;>;"
    ...
    .end local v4    # "r":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/UserProfile;>;"
    :goto_1
    return-object v6
    ...
    .restart local v4    # "r":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/vkontakte/android/UserProfile;>;"
    :cond_1
...
.method public setCallback(Lcom/vkontakte/android/api/AccountGetBanned$Callback;)Lcom/vkontakte/android/APIRequest;
    .locals 0
    .param p1, "cb"    # Lcom/vkontakte/android/api/AccountGetBanned$Callback;

    .prologue
    .line 47
    iput-object p1, p0, Lcom/vkontakte/android/api/AccountGetBanned;->callback:Lcom/vkontakte/android/api/AccountGetBanned$Callback;

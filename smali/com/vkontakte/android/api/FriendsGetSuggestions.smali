...
.method public constructor <init>()V
    ...
    const-string v3, "var f=API.friends.getSuggestions({filter:\"mutual\",fields:\"%s,education,city,country\",count:50});var cities=API.places.getCityById({city_ids:f@.city});var countries=API.places.getCountryById({country_ids:f@.country});return {f:f,ct:cities,cn:countries,mc:API.getProfiles({user_ids:%d,fields:\"country\"})[0].country};"

...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/vkontakte/android/api/WallGetById;->parse(Lorg/json/JSONObject;)V
.end annotation
...
.field private final synthetic val$items:Lorg/json/JSONArray;
...
# direct methods
.method constructor <init>(Lcom/vkontakte/android/api/WallGetById;Ljava/util/HashMap;Ljava/util/HashMap;Lorg/json/JSONArray;)V
    .locals 0
    ...
    iput-object p4, p0, Lcom/vkontakte/android/api/WallGetById$2;->val$items:Lorg/json/JSONArray;
...
.method public success(Lorg/json/JSONObject;)V
    ...
    .line 107
    iget-object v6, p0, Lcom/vkontakte/android/api/WallGetById$2;->this$0:Lcom/vkontakte/android/api/WallGetById;

    iget-object v7, p0, Lcom/vkontakte/android/api/WallGetById$2;->val$names:Ljava/util/HashMap;

    iget-object v8, p0, Lcom/vkontakte/android/api/WallGetById$2;->val$photos:Ljava/util/HashMap;

    iget-object v9, p0, Lcom/vkontakte/android/api/WallGetById$2;->val$items:Lorg/json/JSONArray;

    invoke-static {v6, v7, v8, v9}, Lcom/vkontakte/android/api/WallGetById;->access$0(Lcom/vkontakte/android/api/WallGetById;Ljava/util/HashMap;Ljava/util/HashMap;Lorg/json/JSONArray;)V

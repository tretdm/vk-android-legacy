.class public Lcom/vkontakte/android/api/AccountGetProfileInfo;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/vkontakte/android/api/AccountGetProfileInfo$Callback;
    }
.end annotation


# instance fields
.field callback:Lcom/vkontakte/android/api/AccountGetProfileInfo$Callback;
...
.method public constructor <init>()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/vkontakte/android/api/AccountGetProfileInfo;->param(Ljava/lang/String;Ljava/lang/String;)Lcom/vkontakte/android/APIRequest;
...
.method public invokeCallback(Ljava/lang/Object;)V
    ...
    .prologue
    .line 77
    iget-object v1, p0, Lcom/vkontakte/android/api/AccountGetProfileInfo;->callback:Lcom/vkontakte/android/api/AccountGetProfileInfo$Callback;
    ...
    invoke-interface {v1, v2, v3}, Lcom/vkontakte/android/api/AccountGetProfileInfo$Callback;->fail(ILjava/lang/String;)V
    ...
    .end local p1    # "result":Ljava/lang/Object;
    invoke-interface {v1, p1}, Lcom/vkontakte/android/api/AccountGetProfileInfo$Callback;->success(Landroid/os/Bundle;)V
...
.method public parse(Lorg/json/JSONObject;)Ljava/lang/Object;
    ...
    :goto_0
    :try_start_2
    const-string v11, "bdate_vis"

    const-string v12, "bdate_visibility"
    ...
    .local v7, "status":I
    :cond_3
    const-string v11, "name_req_status"
    ...
    .line 62
    :cond_4
    const-string v10, "name_req_name"
...
.method public setCallback(Lcom/vkontakte/android/api/AccountGetProfileInfo$Callback;)Lcom/vkontakte/android/APIRequest;
    .locals 0
    .param p1, "cb"    # Lcom/vkontakte/android/api/AccountGetProfileInfo$Callback;

    .prologue
    .line 72
    iput-object p1, p0, Lcom/vkontakte/android/api/AccountGetProfileInfo;->callback:Lcom/vkontakte/android/api/AccountGetProfileInfo$Callback;

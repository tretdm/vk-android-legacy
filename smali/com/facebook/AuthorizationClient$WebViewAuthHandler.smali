...
.field private transient loginDialog:Lcom/facebook/WebDialog;
...
.method cancel()V
    ...
    .prologue
    .line 602
    iget-object v0, p0, Lcom/facebook/AuthorizationClient$WebViewAuthHandler;->loginDialog:Lcom/facebook/WebDialog;
    ...
    iput-object v0, p0, Lcom/facebook/AuthorizationClient$WebViewAuthHandler;->loginDialog:Lcom/facebook/WebDialog;
...
.method onWebDialogComplete(Lcom/facebook/AuthorizationClient$AuthorizationRequest;Landroid/os/Bundle;Ljava/lang/RuntimeException;)V
    .locals 11
    .param p1, "request"    # Lcom/facebook/AuthorizationClient$AuthorizationRequest;
    .param p2, "values"    # Landroid/os/Bundle;
    .param p3, "error"    # Ljava/lang/RuntimeException;
    ...
    invoke-static {v6, v5}, Lcom/facebook/AuthorizationClient$Result;->createTokenResult(Lcom/facebook/AuthorizationClient$AuthorizationRequest;Ljava/lang/String;)Lcom/facebook/AuthorizationClient$Result;
    ...
    .end local p3    # "error":Ljava/lang/RuntimeException;
    :goto_0
    iget-object v6, p0, Lcom/facebook/AuthorizationClient$WebViewAuthHandler;->e2e:Ljava/lang/String;

    invoke-static {v6}, Lcom/facebook/AuthorizationClient;->isNullOrEmpty(Ljava/lang/Object;)Z
    ...
    invoke-static {v6, v7, v8}, Lcom/facebook/AuthorizationClient;->access$100(Lcom/facebook/AuthorizationClient;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .restart local p3    # "error":Ljava/lang/RuntimeException;
    :cond_2
    instance-of v6, p3, Ljava/util/concurrent/CancellationException;
...
.method tryAuthorize(Lcom/facebook/AuthorizationClient$AuthorizationRequest;)Z
    ...
    invoke-static {v5}, Lcom/facebook/AuthorizationClient;->isNullOrEmpty(Ljava/lang/Object;)Z
    ...
    invoke-static {v3}, Lcom/facebook/AuthorizationClient;->isNullOrEmpty(Ljava/lang/Object;)Z
    ...
    .line 636
    .local v1, "listener":Lcom/facebook/WebDialog$OnCompleteListener;
    invoke-static {}, Lcom/facebook/AuthorizationClient;->access$000()Ljava/lang/String;
    ...
    invoke-virtual {v5, v1}, Lcom/facebook/AuthorizationClient$AuthDialogBuilder;->setOnCompleteListener(Lcom/facebook/WebDialog$OnCompleteListener;)Lcom/facebook/WebDialog$BuilderBase;

    move-result-object v0

    check-cast v0, Lcom/facebook/WebDialog$Builder;

    .line 643
    .local v0, "builder":Lcom/facebook/WebDialog$Builder;
    invoke-virtual {v0}, Lcom/facebook/WebDialog$Builder;->build()Lcom/facebook/WebDialog;

    move-result-object v5

    iput-object v5, p0, Lcom/facebook/AuthorizationClient$WebViewAuthHandler;->loginDialog:Lcom/facebook/WebDialog;

    .line 644
    iget-object v5, p0, Lcom/facebook/AuthorizationClient$WebViewAuthHandler;->loginDialog:Lcom/facebook/WebDialog;

    invoke-virtual {v5}, Lcom/facebook/WebDialog;->show()V

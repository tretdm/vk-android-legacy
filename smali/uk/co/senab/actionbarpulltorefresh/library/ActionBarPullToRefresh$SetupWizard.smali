...
.method public setup(Luk/co/senab/actionbarpulltorefresh/library/PullToRefreshLayout;)V
    ...
    .prologue
    .line 92
    iget-object v4, p0, Luk/co/senab/actionbarpulltorefresh/library/ActionBarPullToRefresh$SetupWizard;->mActivity:Landroid/app/Activity;

    iget-object v5, p0, Luk/co/senab/actionbarpulltorefresh/library/ActionBarPullToRefresh$SetupWizard;->mOptions:Luk/co/senab/actionbarpulltorefresh/library/Options;

    invoke-virtual {p1, v4, v5}, Luk/co/senab/actionbarpulltorefresh/library/PullToRefreshLayout;->createPullToRefreshAttacher(Landroid/app/Activity;Luk/co/senab/actionbarpulltorefresh/library/Options;)Luk/co/senab/actionbarpulltorefresh/library/PullToRefreshAttacher;

    move-result-object v0

    .line 94
    .local v0, "attacher":Luk/co/senab/actionbarpulltorefresh/library/PullToRefreshAttacher;
    iget-object v4, p0, Luk/co/senab/actionbarpulltorefresh/library/ActionBarPullToRefresh$SetupWizard;->mOnRefreshListener:Luk/co/senab/actionbarpulltorefresh/library/listeners/OnRefreshListener;

    invoke-virtual {v0, v4}, Luk/co/senab/actionbarpulltorefresh/library/PullToRefreshAttacher;->setOnRefreshListener(Luk/co/senab/actionbarpulltorefresh/library/listeners/OnRefreshListener;)V

    .line 96
    iget-object v4, p0, Luk/co/senab/actionbarpulltorefresh/library/ActionBarPullToRefresh$SetupWizard;->mViewGroupToInsertInto:Landroid/view/ViewGroup;
    ...
    invoke-static {v4, p1}, Luk/co/senab/actionbarpulltorefresh/library/ActionBarPullToRefresh$SetupWizard;->insertLayoutIntoViewGroup(Landroid/view/ViewGroup;Luk/co/senab/actionbarpulltorefresh/library/PullToRefreshLayout;)V
    ...
    .line 103
    iget-object v4, p0, Luk/co/senab/actionbarpulltorefresh/library/ActionBarPullToRefresh$SetupWizard;->refreshableViewIds:[I
    ...
    invoke-virtual {p1, v4}, Luk/co/senab/actionbarpulltorefresh/library/PullToRefreshLayout;->addChildrenAsPullable([I)V

    .line 112
    :goto_0
    iget-object v4, p0, Luk/co/senab/actionbarpulltorefresh/library/ActionBarPullToRefresh$SetupWizard;->mViewDelegates:Ljava/util/HashMap;
    ...
    check-cast v5, Luk/co/senab/actionbarpulltorefresh/library/viewdelegates/ViewDelegate;

    invoke-virtual {v0, v4, v5}, Luk/co/senab/actionbarpulltorefresh/library/PullToRefreshAttacher;->useViewDelegate(Ljava/lang/Class;Luk/co/senab/actionbarpulltorefresh/library/viewdelegates/ViewDelegate;)V
    ...
    :cond_1
    iget-object v4, p0, Luk/co/senab/actionbarpulltorefresh/library/ActionBarPullToRefresh$SetupWizard;->refreshableViews:[Landroid/view/View;
    ...
    invoke-virtual {p1, v4}, Luk/co/senab/actionbarpulltorefresh/library/PullToRefreshLayout;->addChildrenAsPullable([Landroid/view/View;)V
